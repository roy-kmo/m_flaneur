/**
 * @file
 * Customized core LineItems component to include color name on items
 */
...
class FlaneurLineItems extends Component {
  /**
  ...
  renderLineItem(uniqueItem) {
    ...
    return (
      <div className="order-items invoice-item">
        ...
        >
          <div className="order-item-media" style={productImageStyle}>
            <div>
          ...
          <div className="order-item-details">
            <div className="order-detail-title">
              ...
              {uniqueItem.colorName && ` - ${uniqueItem.colorName}` || ''}
              </small>
            </div>
          </div>
...
replaceComponent("LineItems", FlaneurLineItems);

export default FlaneurLineItems;
