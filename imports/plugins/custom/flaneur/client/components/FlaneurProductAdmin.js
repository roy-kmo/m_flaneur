...
class FlaneurProductAdmin extends Component {
  constructor(props) {
    super(props);
          ...
          <Components.CardBody expandable={true}>
            ...
            <div className="rui form-group">
              ...
              <ContentEditor
                ...
                onChange={(value) => this.handleFieldChange(null, value, 'description')}
                onBlur={(value) => this.handleFieldBlur(null, this.product.description, 'description')}
              />
            </div>
            <div className="rui form-group">
              <label><span>Care Instructions</span></label>
              <ContentEditor
                value={this.product.careInstructions}
                onChange={(value) => this.handleFieldChange(null, value, 'careInstructions')}
                onBlur={(value) => this.handleFieldBlur(null, this.product.careInstructions, 'careInstructions')}
              />
            </div>
            <div className="rui form-group">
              ...
              <ContentEditor
                ...
                onChange={(value) => this.handleFieldChange(null, value, 'dimensions')}
...
replaceComponent('ProductAdmin', FlaneurProductAdmin);
