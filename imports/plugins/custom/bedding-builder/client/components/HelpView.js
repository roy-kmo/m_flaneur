...
export default class HelpView extends Component {
  ...
  render () {
          ...
          <div class="row-bedding w-row">
            ...
            <div class="bedding-builder-3-column w-col w-col-3 w-col-stack">
              <div class="bedding-builder-containerblock"><img src="/images/Oval-21.png" width="259" srcset="/images/Oval-21-p-500.png 500w, /images/Oval-21.png 518w" sizes="220px" class="bedding-oval-shape"/>
                <div class="bedding-build-1-line option color-tips" onClick={onColorTipsClick}><a href="#" class="bedding-link">Using Color Guide</a><img src="/images/question-mark-1question-mark.png" width="19" class="question-centered"/></div>
              </div>
            </div>
            <div class="bedding-builder-3-column w-col w-col-4 w-col-stack">
              <div class="bedding-builder-containerblock"><img src="/images/Oval-21.png" width="259" srcset="/images/Oval-21-p-500.png 500w, /images/Oval-21.png 518w" sizes="220px" class="bedding-oval-shape"/>
                <div class="bedding-build-1-line option capsules" onClick={onCapsulesClick}><a href="#" class="bedding-link">See Designer Capsules</a><img src="/images/question-mark-1question-mark.png" width="19" class="question-centered"/></div>
              </div>
            </div>
            <div class="bedding-builder-3-column w-col w-col-3 w-col-stack">
              <div class="bedding-builder-containerblock"><img src="/images/Oval-21.png" width="259" srcset="/images/Oval-21-p-500.png 500w, /images/Oval-21.png 518w" sizes="220px" class="bedding-oval-shape"/>
    ...
    <div class="help-block w-container">
      <div class="row-28 w-row">
        <div class="column-22 w-col w-col-4">
          <div>
            <h1 class="heading-7">Chat with us</h1>
            <p class="paragraph-3">Our concierge is available to assist you with color selections and more. </p><a href="#" class="side-button">Chat</a></div>
        </div>
        <div class="column-22 w-col w-col-4">
          <div>
            <h1 class="heading-7">Get color tips</h1>
            <p class="paragraph-3">Get practical expert color advice from interior design insiders.</p>
          </div><a href="#" class="side-button">See Color Tips</a></div>
        <div class="column-22 w-col w-col-4">
          <div>
            <h1 class="heading-7">Explore the blog</h1>
            <p class="paragraph-3">Read our blog for color inspiration, how-to guides, and much more. </p><a href="#" class="side-button">Go to Salon</a></div>
        </div>
      </div>
    </div>
    <BackLink {...this.props} />
